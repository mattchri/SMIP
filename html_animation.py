...
#images. The code re-writes the html_template described below and
#inserts the list of pre-generated png files into the new html file
#
#Required Inputs:
...
#Original file can be found here: http://storm.colorado.edu/~cassano/atoc4720/Daily_images/20171025/gom_vis.html
